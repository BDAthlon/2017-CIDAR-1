...
exports.getGlyph = function (req, res) {
    ...
    Glyph.findById(glyphid,function (err, glyph) {
...
exports.createGlyph = function (req, res) {
    ...
    newglyph.createNewGlyphVersion(req.payload);

    User.findByIdAndUpdate(userid, { $push: { workspaces: newglyph._id } }, { safe: true, upsert: true }, function(err, user) {
            if (err) {
                res.sendStatus(500);
                throw err;
            }
...
exports.deleteGlyph = function (req, res) {
    ...
    User.findByIdAndUpdate(userid, { $push: { workspaces: glyphid } }, function(err, data){
        if(err) {res.sendStatus(500); throw err;}
